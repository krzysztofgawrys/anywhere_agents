"""worker-codex SessionManager - thin wrapper over the shared manager.

See worker-claude/src/sdk/manager.py for the rationale. Identical
shape; we just bind the shared manager to our codex Session class.
"""
...
class SessionManager(_SharedSessionManager):
    """worker-codex flavor: shared manager parameterized with Session."""
