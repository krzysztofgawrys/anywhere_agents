"""worker-windows SessionManager - thin wrapper over the shared manager.
...
WS message routing). Worker-windows only needs to bind it to its own
...
class SessionManager(_SharedSessionManager):
    """worker-windows flavor: shared manager parameterized with Session."""
