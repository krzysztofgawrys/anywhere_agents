...
Inbound-mode env vars:
  ...
  WORKER_TYPE         agent SDK family (default: "copilot")
...
def _build_dialer() -> HubDialer:
    ...
    return HubDialer(
        ...
        worker_type=os.getenv("WORKER_TYPE", "copilot"),
...
app = FastAPI(title="Agents Anywhere Worker (Copilot)", version="0.1.0", lifespan=lifespan)
