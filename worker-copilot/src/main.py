"""worker-copilot entry point - WS server for hub connections.

Mirror of worker-claude/src/main.py with two changes:
- imports projects.scanner from this package (Copilot-specific layout)
- listens on a different default port (compose binds 8003)
"""
